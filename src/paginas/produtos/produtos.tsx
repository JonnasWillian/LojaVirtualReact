...
function Main() {
    return ( 
      <div>
        ...
        <div className="venda">
            <br/>
            <button><a rel='noreferrer' href="https://api.whatsapp.com/send?phone=5571999697820&text=Ol%C3%A1%2C%20gostaria%20de%20contratar%20os%20seus%20servi%C3%A7os" target="_blank">COMPRAR</a></button>
        </div>
